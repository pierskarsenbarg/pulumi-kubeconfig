...
class AksKubeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_name: Name of the AKS cluster you want the Kubeconfig from.
        :param pulumi.Input[builtins.str] resource_group_name: Name of the resource group that the cluster is part of.
        :param pulumi.Input[builtins.bool] is_admin: Specify whether you want to retrieve the admin kubeconfig or the user kubeconfig. Default value is false
        """
