...
class GkeKubeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_name: Name of the GKE cluster you want to generate the kubeconfig for
        """
...
class GkeKubeConfig(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="certificateData")
    def certificate_data(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "certificate_data")
