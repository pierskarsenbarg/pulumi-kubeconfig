...
class EksKubeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_endpoint: Endpoint for your Kubernetes API server.
        :param pulumi.Input[builtins.str] cluster_name: Name of the EKS cluster you want to generate the kubeconfig for
        :param pulumi.Input[builtins.str] certificate_data: Base64 encoded certificate data required to communicate with your cluster.
        :param pulumi.Input[builtins.str] profile: AWS Profile name. This will overwrite any environment variables set.
        :param pulumi.Input[builtins.str] region: Region that the EKS cluster is in. Optional
        :param pulumi.Input[builtins.str] role_arn: Role arn that you want the kubeconfig to use. Optional
        """
