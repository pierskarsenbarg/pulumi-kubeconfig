...
namespace PiersKarsenbarg.Pulumi.Kubeconfig
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pierskarsenbarg/pulumi-kubeconfig";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PiersKarsenbarg.Pulumi.Kubeconfig.version.txt");
    ...
    internal sealed class KubeconfigResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KubeconfigResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
